...
?>
        ...
        <input type='button' name='backBtn' id='backBtn' value='回首頁' onclick='javascript:location.href = "index.html"' /> <br>
        <!-- 直接PO文到FB: FB.ui() -->
        ...
        <script>
            window.fbAsyncInit = function() {
                // init the FB JS SDK
                FB.init({
                    appId: '1438113799749811', // App ID from the app dashboard
